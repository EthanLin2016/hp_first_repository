...
public  class HTTPUtils3 {
	private static HttpClient httpClient3=new DefaultHttpClient();
	...
	public static String gethtml(String redirectLocation) {  
        ...
        String responseBody = "";  
        try {  
            responseBody = httpClient3.execute(httpget, responseHandler);  
        } catch (Exception e) {
            e.printStackTrace();  
            responseBody = null;  
        } finally {  
...
//        list.add(new BasicNameValuePair("vercode", captcha_solution));
        ...
        try {
            ...
            HttpResponse response=httpClient3.execute(httpPost);
     ...
     */
	 public static void downImg(String src) throws IOException{
	        ...
	        //图片下载保存地址
	        File file=new File("d:\\tuxiangshibie\\IdentifyingCode\\3.png");
	        if(file.exists()){
	            file.delete();
	        }
	        ...
	        try {
	            ...
	            System.out.print("httpClient3-------"+httpClient3);
	            HttpEntity entity = response.getEntity();
