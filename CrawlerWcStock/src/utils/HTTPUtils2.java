...
public  class HTTPUtils2 {
	private static HttpClient httpClient2=new DefaultHttpClient();
...
//        list.add(new BasicNameValuePair("vercode", captcha_solution));
     ...
     */
	 public static void downImg(String src) throws IOException{
	        ...
	        //图片下载保存地址
	        File file=new File("d:\\tuxiangshibie\\IdentifyingCode\\2.png");
	        if(file.exists()){
	            file.delete();
	        }
	        ...
	        try {
	            ...
	            System.out.print("httpClient2-------"+httpClient2);
	            HttpEntity entity = response.getEntity();
